...
//
//    //Mobile Phone Number
//    $demoMaskedInput.find('.mobile-phone-number').inputmask('+99 (99) 99999-9999', { placeholder: '+__ (__) _____-_____' });
//    //Phone Number
//    $demoMaskedInput.find('.phone-number').inputmask('+99 (99) 9999-9999', { placeholder: '+__ (__) ____-____' });
//
//    //Dollar Money
//    $demoMaskedInput.find('.money-real').inputmask('R$ 99,99', { placeholder: 'R$ __,__' });
//    //Euro Money
