 ...
 */
namespace core\component\Dompdf\src\Frame;

use core\component\Dompdf\src\Css\Style;
use core\component\Dompdf\src\Dompdf;
use core\component\Dompdf\src\Exception;
use core\component\Dompdf\src\Frame;
use core\component\Dompdf\src\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use core\component\Dompdf\src\FrameDecorator\Page as PageFrameDecorator;
use core\component\Dompdf\src\FrameReflower\Page as PageFrameReflower;
use core\component\Dompdf\src\Positioner\AbstractPositioner;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "core\\component\\Dompdf\\src\\FrameDecorator\\$decorator";
        $reflower   = "core\\component\\Dompdf\\src\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\core\\component\\Dompdf\\src\\Positioner\\'.$type;
