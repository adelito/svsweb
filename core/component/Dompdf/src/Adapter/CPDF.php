...
namespace core\component\Dompdf\src\Adapter;

use core\component\Dompdf\src\Canvas;
...
use core\component\Dompdf\src\PhpEvaluator;
...
//        die('111111');
        ...
        $this->_pdf = new \core\component\Dompdf\lib\Cpdf(
            $size,
            true,
    ...
    protected function _convert_gif_bmp_to_png($image_url, $type)
    {
        ...
        if (!function_exists($func_name)) {
            ...
            $func_name = "\\core\\component\\Dompdf\\src\\Helpers::" . $func_name;
        }
