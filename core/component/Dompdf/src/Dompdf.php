 ...
 */
namespace core\component\Dompdf\src;

use DOMDocument;
use DOMNode;
use core\component\Dompdf\src\Adapter\CPDF;
use DOMXPath;
use core\component\Dompdf\src\Frame\Factory;
use core\component\Dompdf\src\Frame\FrameTree;
use HTML5_Tokenizer;
use HTML5_TreeBuilder;
use core\component\Dompdf\src\Image\Cache;
use core\component\Dompdf\src\Renderer\ListBullet;
use core\component\Dompdf\src\Css\Stylesheet;
...
class Dompdf
{
    ...
    */
    ...
    public function loadHtml($str, $encoding = 'UTF-8')
    {
        ...
        set_error_handler(array("\\core\\component\\Dompdf\\src\\Helpers", "record_warnings"));
        ...
        if ($this->options->isHtml5ParserEnabled() && class_exists("HTML5_Tokenizer")) {
            ...
            $tag_names = array("html", "table", "tbody", "thead", "tfoot", "tr", "section");
